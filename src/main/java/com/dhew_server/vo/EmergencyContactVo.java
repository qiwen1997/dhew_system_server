...
public class EmergencyContactVo {
    ...
    Integer default_phone; //是否为默认联系人，是为1，否为0
    public EmergencyContactVo() {
    }

    public EmergencyContactVo(String user_phone, String contact_name, String contact_phone) {
    ...
    public EmergencyContactVo(Integer eme_id, String user_phone, String contact_name, String contact_phone) {
        this.eme_id = eme_id;
        this.user_phone = user_phone;
        this.contact_name = contact_name;
        this.contact_phone = contact_phone;
	...
	public String toString() {
		return "EmergencyContactVo [eme_id=" + eme_id + ", user_phone=" + user_phone + ", contact_name=" + contact_name
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmergencyContactVo)) return false;

        EmergencyContactVo that = (EmergencyContactVo) o;
